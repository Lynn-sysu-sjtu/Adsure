        ...
        for index, observation in enumerate(frame.get("ocr", [])):
            ...
            evidence.append(
                EvidenceUnit(
                    ...
                    frame_ids=[frame_id],
                    provider=observation.get("provider", "Apple Vision/VNRecognizeTextRequest"),
                    provider_version=observation.get("provider_version", "macOS-native"),
...
def analyze_video(
    ...
    *,
    ...
    with ThreadPoolExecutor(max_workers=2) as executor:
        audio_future = executor.submit(transcribe_video, video, destination, industry) if asr_mode == "auto" else None
        try:
    ...
    manifest = {
        ...
        "artifacts": {
            ...
            "asr_hotwords_sha256": _sha256(PROJECT_ROOT / "data/rules/asr_hotwords.json"),
            "asr_hotword_industry": industry,
